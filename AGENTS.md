...
Este repositório (**Prisma Tradutor**, privado) é a fonte da verdade. Para publicar no
GitHub Community, use `./scripts/publish-community.sh` — ver [`docs/REPOS.md`](docs/REPOS.md).
