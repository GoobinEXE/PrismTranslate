...
struct LogsSettingsView: View {
    ...
    private func copyAll() {
        ...
        let lines = store.fullExportLineCount()
        copyToPasteboard(text, feedback: "Copiado (\(lines))")
